...
public class ClientSamplePE {
	...
	public static void main(String[] args) {
	        ...
	        recepcionRequest.setVuniorgdst("PRESIDENTE EJECUTIVO");
			recepcionRequest.setVnomdst("JUAN JOSÉ MARTÍNEZ ORTIZ");
			recepcionRequest.setVnomcardst("CONSEJO EJECUTIVO");
			recepcionRequest.setVasu("ENVIO PRUEBA PCM PARA PE");
	        ...
	        recepcionRequest.setVcuo("0000006741"); ;
	       // recepcionRequest.setVcuoref("000000202");			
			...
			recepcionRequest.setVnomdoc("ENVIO.pdf");
